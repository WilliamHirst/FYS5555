...
\begin{figure}[H]
    ...
    \label{fig:WW}
\end{figure}
In figure \ref{fig:WZ} I have drawn a Feynman diagram of WZ. The figure shows an up quark annihilating coupled to a W-boson and a down quark, and a anti-down quark coupled to a the aforementioned down quark and a Z-boson. The W-boson decays into a charged and neutral lepton pair and the Z can decay into a pair quarks or leptons. 
\begin{figure}
    \centering
    \begin{tikzpicture}
    \begin{feynman}
